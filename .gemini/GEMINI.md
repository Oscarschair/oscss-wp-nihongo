...
3. **4大カテゴリー別完全統一規格の構成要素（必須照合）**:
   - 🏪 **街角サバイバル【RPGバトルコマンド型】**:
     - 正本: `thumb_street_cafe_order_rpg.jpg`
     - 上部中央白地カード（薄黄色「🏪 街角サバイバル」ピルタグ＋極太見出し＋サブ見出し）＋ 左側勇者クルマ（剣＆盾）＋ 右側笑顔の店員・NPC吹き出し ＋ 下部青色レトロRPGコマンドウィンドウ（▶たたかう/どうぐ/にげる）。
   - 🔍 **くらべてみました【中央思案 ＆ 左右VS対比型】**:
     - 正本: `thumb-kurabete-zenzen-mattaku.jpg`
     - 和風青海波ベージュ背景 ＋ 中央思案クルマ ＋ 頭上思考もくもく吹き出し ＋ 左側オレンジ角丸正方形カード（極太縦書き＋アイコン）＋ 右側水色角丸正方形カード（極太縦書き＋アイコン）＋ 中央立体「VS」ロゴ。
   - 🗣️ **ことばのあや【耳ペン解説レクチャー型】**:
     - 正本: `thumb-kotoba-sumimasen-faces.jpg` / `thumb-kotoba-yo-jouhou.jpg`
     - パステルラベンダー（#F0E7F5）背景 ＋ 左側クルマ（耳にペンを挟むトレードマーク、解説笑顔）＋ 右側薄紫カード（「〇〇」の話＋解説）＋ 四隅の丸アイコン（電球・ハート等）。
   - 🌏 **カルチャーショック【左上公式カード型】**:
     - 正本: `thumb-culture-no-trash-cans-clean-streets.jpg`
