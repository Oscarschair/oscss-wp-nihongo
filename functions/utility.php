...
function oscss_get_series_categories() {
	return array(
		'comparing' => array(
			...
			'color_key'   => 'vs',
			'hook'        => '「謝っていない」のはどっち？',
			'desc'        => '似ているのにニュアンスが真逆！？使い分けを間違えると誤解される日本語をズバッと比較。',
			'examples'    => array( '「あげる」vs「くれる」', '「さようなら」の真意', 'すみませんの正体' ),
		...
		'kotoba-no-aya' => array(
			...
			'color_key'   => 'aya',
			'hook'        => '「大丈夫です」はYESかNOか？',
			'desc'        => '言葉通りに受け取ると大事故に！？日本人の「本音・同調・空気感」のニュアンスを解き明かす。',
			'examples'    => array( '「大丈夫」YES/NOの罠', 'アニメ終助詞「ぞ・ぜ」', '「〜よね」の同調' ),
			'lead'        => '助詞や言葉のニュアンス解説',
		),
		'culture-shock' => array(
			...
			'color_key'   => 'culture',
			'hook'        => '小1が一人で電車に乗る衝撃',
			'desc'        => '世界から見たら日本の日常は奇跡の連続？香港出身の視点で見つけた「日本のここがスゴい＆フシギ」。',
			'examples'    => array( '車がピタッと止まる奇跡', '電車の「静けさ」の謎', '落とし物が戻る国' ),
			'lead'        => '日本と海外の習慣・日常の発見',
		),
		'street-japanese' => array(
			...
			'color_key'   => 'street',
			'hook'        => '教科書にはないリアルの洗礼',
			'desc'        => 'コンビニ・駅・居酒屋・美容室。教科書に載っていない現場の生きたやり取りとマナーを徹底攻略。',
			'examples'    => array( 'コンビニレジ3連撃', '視界ゼロの美容室シャンプー', '駅・改札ダンジョン' ),
